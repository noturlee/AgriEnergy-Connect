...
namespace FireBasics.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoryId,CategoryName,Image_Url")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoryId,CategoryName,Image_Url")] Category category)
        {
